...
_Last verified: **2026-08-26 19:11 UTC** — refreshed automatically by the pipeline and the **Update community translations** workflow._

| Source | Pinned (this repo) | Upstream HEAD | Status |
|---|---|---|---|
| Game build (P4CL) | `4.10.0-live-12519617` <br/> `(P4CL: 12519617)` | — | — |
| french — `Dymerz/StarCitizen-Localization@main` | [`1046f3d`](https://github.com/Dymerz/StarCitizen-Localization/commit/1046f3de3db15f6d06a7183f27b9ed8763e54c1c) | `1046f3d` | ✅ up to date (pinned at build) |
| italian — `Dymerz/StarCitizen-Localization@main` | [`1046f3d`](https://github.com/Dymerz/StarCitizen-Localization/commit/1046f3de3db15f6d06a7183f27b9ed8763e54c1c) | `1046f3d` | ✅ up to date (pinned at build) |
| portuguese_br — `danielgmota/StarCitizen-Localization@develop` | [`6719290`](https://github.com/danielgmota/StarCitizen-Localization/commit/6719290e48f80868f7aeb75c771a2e8f8b5f4b1f) | `6719290` | ✅ up to date (pinned at build) |
| portuguese_br_dymerz — `Dymerz/StarCitizen-Localization@main` | [`1046f3d`](https://github.com/Dymerz/StarCitizen-Localization/commit/1046f3de3db15f6d06a7183f27b9ed8763e54c1c) | `1046f3d` | ✅ up to date (pinned at build) |
