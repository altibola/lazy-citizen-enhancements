...
# they use. The variant folder suffix is "_all" for every language; languages
# sharing a glossary (both PT-BR sources) are translated identically.
ENHANCEMENT_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "portuguese_br_alt": {"glossary": "pt_br", "suffix": "_all"},
}
